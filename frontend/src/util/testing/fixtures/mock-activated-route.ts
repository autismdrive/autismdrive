...
export const mockResourceDetailsRoute = makeMockActivatedRoute(
  {},
  mockParamsWithResourceId,
  'resource/:resourceId',
);

/** Mock Activated Route for Resource Editing Form */
export const mockResourceEditRoute = makeMockActivatedRoute(
  {},
  mockParamsWithResourceId,
...
export const mockCovidRoute = makeMockActivatedRoute(
  {},
  mockParamsWithCategoryName,
  'covid19-resources/:category',
);
