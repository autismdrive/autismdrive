...
export class Covid19Categories {
  static labels = {
    ...
    Health_and_Telehealth:
      "Health and Telehealth: Online supports to help support the community's mental, behavioral, and " +
      'physical health',
    'Physical Activity': 'Physical Activity: Resources focused on promoting physical activity and exercise',
    Visual_Aids:
      'Visual Aids: Resources to develop visual schedules, social stories, communication aids explaining COVID-19',
    'Edu-tainment':
      'Edu-tainment: Fun educational games, experiences, virtual tours, videos, interactive tools, apps, etc',
    Supports_with_Living:
      'Daily Living Supports: Supports and information related to daily living needs and supporting daily ' +
      'living needs at home (e.g., with family, group care, residential supports)',
    Free_educational_resources:
      'Free Educational Resources: Curriculum based courses, classes, and textbooks; subscriptions',
  };
}
