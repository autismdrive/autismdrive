...
class TestUser(BaseTest, unittest.TestCase):
    ...
    def test_login_user(self):
        ...
        rv = self.app.post("/api/login_password", data=self.jsonify(data), content_type="application/json")
    ...
    def test_get_current_user(self):
        ...
        response = self.app.get("/api/session", headers=dict(Authorization="Bearer " + user.encode_auth_token()))
    ...
    def test_forgot_password_sends_email(self):
        ...
        rv = self.app.post("/api/forgot_password", data=self.jsonify(data), content_type="application/json")
        self.assert_success(rv)
        self.assertGreater(len(TEST_MESSAGES), message_count)
    ...
    def test_remove_user_from_study(self):
        ...
        rv = self.app.delete("/api/study_user/%i" % 1, headers=self.logged_in_headers())
        self.assert_success(rv)
        rv = self.app.get("/api/study/%i/user" % 1, content_type="application/json", headers=self.logged_in_headers())
        self.assert_success(rv)
        response = json.loads(rv.get_data(as_text=True))
    ...
    def test_remove_favorite_from_user(self):
        ...
        rv = self.app.delete("/api/user_favorite/%i" % 1, headers=self.logged_in_headers())
        self.assert_success(rv)
        rv = self.app.get(
    ...
    def test_delete_user_deletes_favorites(self):
        ...
        rv = self.app.get("/api/user_favorite", content_type="application/json", headers=self.logged_in_headers())
        self.assert_success(rv)
        response = json.loads(rv.get_data(as_text=True))
        self.assertEqual(0, len(response))
