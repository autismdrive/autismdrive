...
def downgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["participant_id"], ["stardrive_participant.id"], name="current_behaviors_questionnaire_participant_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["stardrive_user.id"], name="current_behaviors_questionnaire_user_id_fkey"
        ),
