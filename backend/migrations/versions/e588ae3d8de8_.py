...
def downgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["participant_id"], ["stardrive_participant.id"], name="home_questionnaire_participant_id_fkey"
        ),
    ...
    op.create_foreign_key(
        "housemate_home_questionnaire_id_fkey", "housemate", "home_questionnaire", ["home_questionnaire_id"], ["id"]
    )
