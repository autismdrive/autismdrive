...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "home_questionnaire", sa.Column("dependant_living_situation", sa.VARCHAR(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "home_questionnaire", sa.Column("dependant_living_other", sa.VARCHAR(), autoincrement=False, nullable=True)
    )
