...
from app.model.study import Study, Status, StudyInvestigator, StudyCategory, StudyUserStatus, StudyUser
...
class InvestigatorSchema(ModelSchema):
    ...
    _links = ma_fields.Hyperlinks(
        {
            "self": ma_fields.URLFor("api.investigatorendpoint", id="<id>"),
            "collection": ma_fields.URLFor("api.investigatorlistendpoint"),
        }
    )
...
class ParentCategorySchema(ModelSchema):
    ...
    _links = ma_fields.Hyperlinks(
        {
            "self": ma_fields.URLFor("api.categoryendpoint", id="<id>"),
            "collection": ma_fields.URLFor("api.categorylistendpoint"),
        }
    )
...
class CategoriesOnEventSchema(ModelSchema):
    ...
    _links = ma_fields.Hyperlinks(
        {
            "self": ma_fields.URLFor("api.eventcategoryendpoint", id="<id>"),
            "category": ma_fields.URLFor("api.categoryendpoint", id="<category_id>"),
            "event": ma_fields.URLFor("api.eventendpoint", id="<resource_id>"),
        }
    )
...
class CategoriesOnLocationSchema(ModelSchema):
    ...
    _links = ma_fields.Hyperlinks(
        {
            "self": ma_fields.URLFor("api.locationcategoryendpoint", id="<id>"),
            "category": ma_fields.URLFor("api.categoryendpoint", id="<category_id>"),
            "location": ma_fields.URLFor("api.locationendpoint", id="<resource_id>"),
        }
    )
...
class CategoriesOnResourceSchema(ModelSchema):
    ...
    _links = ma_fields.Hyperlinks(
        {
            "self": ma_fields.URLFor("api.resourcecategoryendpoint", id="<id>"),
            "category": ma_fields.URLFor("api.categoryendpoint", id="<category_id>"),
            "resource": ma_fields.URLFor("api.resourceendpoint", id="<resource_id>"),
        }
    )
...
class CategoriesOnStudySchema(ModelSchema):
    ...
    _links = ma_fields.Hyperlinks(
        {
            "self": ma_fields.URLFor("api.studycategoryendpoint", id="<id>"),
            "category": ma_fields.URLFor("api.categoryendpoint", id="<category_id>"),
            "study": ma_fields.URLFor("api.studyendpoint", id="<study_id>"),
        }
    )
...
class InvestigatorsOnStudySchema(ModelSchema):
    ...
    _links = ma_fields.Hyperlinks(
        {
            "self": ma_fields.URLFor("api.studyinvestigatorendpoint", id="<id>"),
            "investigator": ma_fields.URLFor("api.investigatorendpoint", id="<investigator_id>"),
            "study": ma_fields.URLFor("api.studyendpoint", id="<study_id>"),
        }
    )
...
class ResourceSchema(ModelSchema):
    ...
    _links = ma_fields.Hyperlinks(
        {
            "self": ma_fields.URLFor("api.resourceendpoint", id="<id>"),
            "collection": ma_fields.URLFor("api.resourcelistendpoint"),
            "categories": ma_fields.URLFor("api.categorybyresourceendpoint", resource_id="<id>"),
        }
    )
...
class EventSchema(ModelSchema):
    ...
    _links = ma_fields.Hyperlinks(
        {
            "self": ma_fields.URLFor("api.eventendpoint", id="<id>"),
            "collection": ma_fields.URLFor("api.eventlistendpoint"),
            "categories": ma_fields.URLFor("api.categorybyeventendpoint", event_id="<id>"),
        }
    )
...
class LocationSchema(ModelSchema):
    ...
    _links = ma_fields.Hyperlinks(
        {
            "self": ma_fields.URLFor("api.locationendpoint", id="<id>"),
            "collection": ma_fields.URLFor("api.locationlistendpoint"),
        }
    )
    ...
    _links = ma_fields.Hyperlinks(
        {
            ...
            "user": ma_fields.URLFor("api.userendpoint", id="<user_id>"),
        }
    )
...
class UsersOnStudySchema(ModelSchema):
    ...
    _links = ma_fields.Hyperlinks(
        {
            "self": ma_fields.URLFor("api.studyuserendpoint", id="<id>"),
            "user": ma_fields.URLFor("api.userendpoint", id="<user_id>"),
            "study": ma_fields.URLFor("api.studyendpoint", id="<study_id>"),
        }
    )
...
class StudySchema(ModelSchema):
    ...
    _links = ma_fields.Hyperlinks(
        {
            "self": ma_fields.URLFor("api.studyendpoint", id="<id>"),
            "collection": ma_fields.URLFor("api.studylistendpoint"),
            "categories": ma_fields.URLFor("api.categorybystudyendpoint", study_id="<id>"),
        }
    )
...
class SearchSchema(Schema):
    ...
    class GeoboxSchema(Schema):
        top_left = fields.Nested(GeopointSchema)
        bottom_right = fields.Nested(GeopointSchema)
    ...
    size = fields.Integer()
    sort = fields.Nested(SortSchema, allow_none=True, default=None)
    types = fields.List(fields.Str())
    ages = fields.List(fields.Str())
    languages = fields.List(fields.Str())
    age_counts = fields.List(fields.Nested(AggCountSchema), dump_only=True)
    language_counts = fields.List(fields.Nested(AggCountSchema), dump_only=True)
    type_counts = fields.List(fields.Nested(AggCountSchema), dump_only=True)
    total = fields.Integer(dump_only=True)
    hits = fields.Nested(HitSchema, many=True, dump_only=True)
    category = fields.Nested(CategoryInSearchSchema)
    ordered = True
    date = fields.DateTime(allow_none=True)
    map_data_only = fields.Boolean()
    geo_box = fields.Nested(GeoboxSchema, allow_none=True, default=None)
