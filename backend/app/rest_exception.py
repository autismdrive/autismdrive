class RestException(Exception):
    ...
    EMAIL_NOT_REGISTERED = {
        ...
        "message": "The email you provided is not associated with any of our accounts. Please enter a different email or register for an account.",
    }
    ...
    STUDY_INQUIRY_ERROR = {
        "code": "study_inquiry_error",
        "message": "Error in finding correct user and study to complete study inquiry",
    }
