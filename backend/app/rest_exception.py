...
class RestException(Exception):
    ...
    EMAIL_NOT_REGISTERED = {'code': 'email_not_registered', 'message': 'The email you provided is not associated with any of our accounts. Please enter a different email or register for an account.'}
