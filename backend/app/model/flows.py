...
class Flows:
    ...
    # SkillStar Flows
    @staticmethod
    def get_skillstar_chain_session_flow():
        flow = Flow(name="skillstar_chain_session")
        flow.relationship = Relationship.self_professional
        flow.add_step('chain_session_assessment_questionnaire')
        return flow

    @staticmethod
    def get_skillstar_flows():
        flows = [
            Flows.get_skillstar_chain_session_flow(),
        ]
        return flows
    ...
    def get_flow_by_name(name):
        ...
        if name == 'skillstar_chain_session':
            return Flows.get_skillstar_chain_session_flow()
