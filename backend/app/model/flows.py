...
class Flows:
    ...
    # SkillStar Flows
    @staticmethod
    def get_skillstar_baseline_flow():
        flow = Flow(name="skillstar_baseline")
        flow.relationship = Relationship.self_professional
        flow.add_step('baseline_assessment_questionnaire')
        return flow

    @staticmethod
    def get_skillstar_flows():
        flows = [
            Flows.get_skillstar_baseline_flow(),
        ]
        return flows
    ...
    def get_flow_by_name(name):
        ...
        if name == 'skillstar_baseline':
            return Flows.get_skillstar_baseline_flow()
