...
class SupportsQuestionnaire(db.Model):
    ...
    def get_meta(self):
        info = {
            ...
            'medications': Medication().get_meta(),
            'therapies': Therapy().get_meta(),
            'assistive_devices': AssistiveDevice().get_meta()
        }
...
class SupportsQuestionnaireSchema(ModelSchema):
    class Meta:
        ...
        fields = ('id', 'last_updated', 'participant_id', 'user_id', 'medications', 'therapies', 'assistive_devices')
