...
class ClinicalDiagnosesQuestionnaire(db.Model):
    ...
    genetic_other = db.Column(
        ...
        info={
            ...
            'type': 'input',
            'template_options': {
                'placeholder': 'Enter genetic condition'
            },
...
class ClinicalDiagnosesQuestionnaireSchema(ModelSchema):
    class Meta:
        ...
        fields = ('id', 'last_updated', 'participant_id', 'user_id', 'developmental', 'developmental_other',
                  'mental_health', 'mental_health_other', 'medical', 'medical_other', 'genetic', 'genetic_other')
