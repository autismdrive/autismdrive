...
class IdentificationQuestionnaire(Base):
    ...
    relationship_to_participant = Column(
        String,
        info={
    ...
    relationship_to_participant_other = Column(
        String,
        info={
            "RELATIONSHIP_REQUIRED": ["dependent"],
            "display_order": 1.2,
    ...
    is_first_name_preferred = Column(
        Boolean,
        info={
            "display_order": 5,
            "type": "radio",
