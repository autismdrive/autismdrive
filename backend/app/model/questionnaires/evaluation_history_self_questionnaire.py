...
class EvaluationHistorySelfQuestionnaire(db.Model):
    ...
    self_identifies_autistic = db.Column(
        ...
        info={
            ...
            "default_value": True,
            "template_options": {
                "label": "Do you self-identify as having Autism?",
                "required": False,
                "options": [
    ...
    has_autism_diagnosis = db.Column(
        ...
        info={
            ...
            "default_value": True,
            "template_options": {
                "label": "Have you been formally diagnosed with Autism Spectrum Disorder?",
                "required": True,
                "options": [
                    {"value": True, "label": "Yes"},
                    {"value": False, "label": "No"},
    ...
    years_old_at_first_diagnosis = db.Column(
        ...
        info={
            ...
            "type": "input",
            "template_options": {
                "label": "How old were you when you were first diagnosed with ASD?",
                "required": True,
            },
        },
    )
    who_diagnosed = db.Column(
        ...
        info={
            ...
            "type": "select",
            "template_options": {
                "label": "Who first diagnosed you with ASD?",
                "required": True,
                "options": [
                    {
                        "value": "pediatrician",
    ...
    where_diagnosed = db.Column(
        ...
        info={
            ...
            "type": "select",
            "template_options": {
                "label": "Where did you receive this diagnosis?",
                "required": True,
                "options": [
                    {
                        "value": "1uvaDp",
                    ...
                    {
                        "value": "5evms",
                        "label": "Eastern Virginia Medical School (EVMS)",
                    },
                    {
                        "value": "6chkd",
                        "label": "Children’s Hospital of the Kings Daughters (CHKD)",
                    },
                    {
                        "value": "7cas",
                        "label": "Commonwealth Autism Services (Virginia Commonwealth University)",
                    },
                    ...
                    {
                        "value": "13vcu",
                        "label": "Children’s Hospital of Richmond (VCU)",
                    },
                    ...
                    {
                        "value": "22occa",
                        "label": "One Child Center for Autism (Williamsburg)",
                    },
    ...
    gives_permission_to_link_evaluation_data = db.Column(
        ...
        info={
            ...
            "default_value": True,
            "template_options": {
                "label": "Do we have your permission to link your evaluation data to the UVA Autism Database?",
                "required": False,
                "options": [
                    {"value": True, "label": "Yes"},
                    {"value": False, "label": "No"},
    ...
    has_iq_test = db.Column(
        ...
        info={
            ...
            "default_value": True,
            "template_options": {
                "label": "Have you been given an IQ or intelligence test?",
                "required": False,
                "options": [
                    {"value": True, "label": "Yes"},
                    {"value": False, "label": "No"},
    ...
    recent_iq_score = db.Column(
        ...
        info={
            ...
            "expression_properties": {
                "template_options.label": '"What was your most recent IQ score?"'
            },
        ...
        info = {
            ...
            "field_groups": {
                "partner_centers": {
                    ...
                    "wrappers": ["card"],
                    "template_options": {
                        "label": "Have you ever been evaluated at any of the following centers?"
                    },
                }
            },
        }
