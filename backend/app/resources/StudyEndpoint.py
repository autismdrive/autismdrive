...
class StudyEndpoint(flask_restful.Resource):
    ...
    def delete(self, id):
        study = db.session.query(Study).filter_by(id=id).delete()
        try:
            elastic_index.remove_resource(study, 'Study')
        except:
    ...
    def put(self, id):
        ...
        db.session.commit()
        elastic_index.update_resource(updated, 'Study')
...
class StudyListEndpoint(flask_restful.Resource):
    ...
    def post(self):
        ...
        try:
            ...
            db.session.commit()
            elastic_index.add_resource(load_result, 'Study')
